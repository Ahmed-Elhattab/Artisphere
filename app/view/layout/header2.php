...
<header class="site-header">
    <div class="header-inner">
        ...
        <!-- MENU AU CENTRE -->
        <nav class="main-nav">
            <a href="?controller=index&action=index" class="nav-link">Catalogue</a>
            <a href="?controller=artisans&action=index" class="nav-link">Artisan</a>
            <a href="?controller=evenement&action=index" class="nav-link">Évènement</a>
        </nav>

        <!-- PROFIL À DROITE -->
        <a href="?controller=profil&action=index" class="profile-icon" aria-label="Mon profil">
            <span>👤</span>
        </a>
