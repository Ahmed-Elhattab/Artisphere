...
class evenement_AFFICHE_controller extends BaseController
{
    ...
    public function index(): void
    {
        ...
        $this->render('evenement_AFFICHE.php', [
            'title'      => 'Artisphere – A l`affiche',
            // important: keep the same CSS name used in the old version
            'pageCss'    => 'evenement_AFFICHE-style.css',
